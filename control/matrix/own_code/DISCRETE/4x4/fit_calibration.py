...
from a captured air run, instead of guessing them, by numerically searching
for the (extinction_ratio, retardance_deg) pair that makes air's
reconstruction closest to its known true Mueller matrix (the identity) --
the "single-reference calibration" phase from NAMING.md/README's
...
# ---------------------------------------------------------------------------
# EDIT THIS to point at a captured air run (4x4 mode).
# ---------------------------------------------------------------------------
AIR_DIRECTORY = r"G:\control\Data\03072026\qwp\air"
# ---------------------------------------------------------------------------
...
def main() -> None:
    ...
    out_dir = RESULT_ROOT / "transmission" / "4x4" / "calibration_fit"
