...
extinction ratio (press Enter to accept the suggested default -- whatever
was last used by this script or main.py in this same folder, remembered in
.last_calibration.json), applied to every sample in this run so they're
all compared on an equal footing.
...
# ---------------------------------------------------------------------------
SAMPLE_DIRECTORIES = [
    r"C:\COMPARE_CASES\Data\02072026\air",
    r"C:\COMPARE_CASES\Data\03072026\lp\lp30",
    r"C:\COMPARE_CASES\Data\03072026\lp\lp45",
    r"C:\COMPARE_CASES\Data\03072026\lp\lp90",
]
# ---------------------------------------------------------------------------
...
def _append_calibration_log(extinction_ratio: float) -> None:
    ...
    with open(_CALIBRATION_LOG_PATH, "a", newline="", encoding="utf-8") as fh:
        ...
        writer.writerow([datetime.now().isoformat(timespec="seconds"),
                          "validate_against_theory (multiple)", extinction_ratio])
...
def main() -> None:
    ...
    base_dir = RESULT_ROOT / "transmission" / "3x3" / "validation_against_theory"
