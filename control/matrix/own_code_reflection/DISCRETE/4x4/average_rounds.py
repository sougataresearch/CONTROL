"""Aggregate a 4x4 Mueller matrix reconstruction across multiple repeated
...
Config/experiment_config.json) laid out as siblings, e.g.:
    ...
    qwp30_round01/  qwp30_round02/  qwp30_round03/
...
# ---------------------------------------------------------------------------
# EDIT THIS: every round of the same sample, same angle set, 4x4 mode.
# ---------------------------------------------------------------------------
ROUND_DIRECTORIES = [
    r"G:\control\Data\03072026\qwp\qwp30_round01",
    r"G:\control\Data\03072026\qwp\qwp30_round02",
    r"G:\control\Data\03072026\qwp\qwp30_round03",
]
