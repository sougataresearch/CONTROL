...
import compare_subsets_4x4 as tool
...
class SyntheticReconstructionTests(unittest.TestCase):
    def test_full_grid_reconstructs_to_identity(self):
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            psg_qwp, psa_qwp, images, fixed_angles, sample_name = tool.load_run(str(run_dir))
    ...
    def test_minimal_16_image_subset_reconstructs_to_identity(self):
        theory = np.eye(4)
        # See own_code/DISCRETE/4x4/test_reconstruction.py: 45-degree-spaced
        # angles are rank-deficient for this physics -- avoid that spacing.
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            np.testing.assert_allclose(matrix_mean, theory, atol=1e-4)
